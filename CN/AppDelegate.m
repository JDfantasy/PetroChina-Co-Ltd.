...
//    ZhanzhangViewController *tabbar = [[ZhanzhangViewController alloc] init];
    
    [self.window setRootViewController:nav];
    
//    HomePageViewController * homeVC=[[HomePageViewController alloc]init];
//    homeVC.title=@"首页";
//    homeVC.tabBarItem.image=[UIImage imageNamed:@"tab_0.png"];
//    homeVC.tabBarItem.title=@"";
//    UINavigationController * homeNav=[[UINavigationController alloc]initWithRootViewController:homeVC];
//    
//    RepairViewController * RepairVC=[[RepairViewController alloc]init];
//    RepairVC.tabBarItem.image=[UIImage imageNamed:@"tab_1.png"];
//    RepairVC.title=@"维修";
...
//    ReimbursementVC.tabBarItem.image=[UIImage imageNamed:@"tab_2.png"];
//    ReimbursementVC.title=@"报销";
//    ReimbursementVC.tabBarItem.title=@"";
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "net.chnzb.CN" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CN" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CN.sqlite"];
    NSError *error = nil;
